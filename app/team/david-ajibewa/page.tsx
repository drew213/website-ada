...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    dateRange: "2015 – 2021",
    description:
      "Graduated with strong academic performance, excelling in sciences (I.e., Biology, Chemistry, Physics).  ",
  },
];
...
export default function page() {
  const [typedText] = useTypewriter({
    words: ["I am David Ajibewa.", "Medical Student and Marketing Strategist."],
    loop: true,
    typeSpeed: 50,
    deleteSpeed: 50,
    delaySpeed: 1200,
      ...
      <main className="flex flex-col bg-white dark:bg-black mx-auto px-4 md:px-16 py-12 max-w-7xl min-h-screen text-gray-800 dark:text-gray-100">
        ...
        <section className="flex md:flex-row flex-col-reverse justify-between items-center gap-8 mb-20">
          ...
          <div className="space-y-5 md:w-1/2 max-w-xl md:text-left text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg sm:text-xl">
              Creative with a passion for neurosurgery, strategic marketing.
              Advertising in innovative ways.
            </p>
          </div>
        ...
        <section className="bg-gray-50 dark:bg-gray-800 shadow-md mx-auto mb-16 p-8 rounded-lg max-w-4xl">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
            I'm a motivated medical student at Lagos State College of Medicine
            with a strong passion for neurosurgery. Committed to developing
            expertise in neurological care through academic excellence, clinical
            exposure, and research. Seeking opportunities to gain hands-on
            experience in medical settings to prepare for a career as a
            neurosurgeon.
          </p>
        </section>
