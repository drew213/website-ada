...
const experiences: Experience[] = [
  {
    ...
    description:
      "Worked with various clients to edit short videos, design graphics, and build visual content for digital platforms like TikTok, Instagram, and YouTube.",
  },
  {
    title: "Architecture Student",
    dateRange: "2022 – Present",
    description:
      "Designed residential and commercial spaces, developed plans in Revit, and created 3D visualizations for academic and personal projects.",
  },
];

const skills = [
  "Architectural design (AutoCAD, Revit)",
...
export default function page() {
  const [typedText] = useTypewriter({
    words: [
      "I am Sheriph Eyitayo Olajide.",
      "Creative Architect & Video Editor.",
      ...
      <main className="flex flex-col bg-white dark:bg-black mx-auto px-4 md:px-16 py-12 max-w-7xl min-h-screen text-gray-800 dark:text-gray-100">
        ...
        <section className="flex md:flex-row flex-col-reverse justify-between items-center gap-8 mb-20">
          ...
          <div className="space-y-5 md:w-1/2 max-w-xl md:text-left text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg sm:text-xl">
              Creative with a passion for architecture, video editing, and
              visual storytelling. Bringing ideas to life in inspiring ways.
            </p>
          </div>
        ...
        <section className="bg-gray-50 dark:bg-gray-800 shadow-md mx-auto mb-16 p-8 rounded-lg max-w-4xl">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
            I’m a creative with a passion for architecture, video editing, and
            visual storytelling. Whether I’m designing a building or crafting a
            video, I enjoy bringing ideas to life in ways that inspire and
            connect with people. I’m always looking for new ways to grow, learn,
        ...
        <section className="space-y-4 bg-gray-50 dark:bg-gray-800 shadow-md mx-auto mb-14 p-8 rounded-lg max-w-4xl text-center">
          ...
          <p>
            📍 Nigeria | ✉️{" "}
            <a
              href="mailto:vhitwrld@email.com"
