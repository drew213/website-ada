...
const experiences: Experience[] = [
  {
    ...
    description:
      "Currently pursuing medical training with a focus on foundational clinical skills and preclinical coursework, Actively engaging in coursework related to human anatomy, physiology, and biochemistry, with an interest in neurological systems. ",
  },
  {
    title: "CTO-Level Consultant & Innovation Strategist",
    dateRange: "2018 – Present",
    description:
      "Designed, refined, and executed bold technological concepts across various domains. Built product architectures and scalable systems rooted in innovation and clarity. Collaborated with founders and creators, guiding vision from idea to execution. Inspired by fiction’s structure, applied storytelling logic to system and solution design.",
  },
];
...
export default function page() {
  const [typedText] = useTypewriter({
    words: [
      "I am Quadri Abdulbasit.",
      "Medical Student and CTO Level Consultant.",
    ],
    loop: true,
    typeSpeed: 50,
    deleteSpeed: 50,
      ...
      <main className="flex flex-col bg-white dark:bg-black mx-auto px-4 md:px-16 py-12 max-w-7xl min-h-screen text-gray-800 dark:text-gray-100">
        ...
        <section className="flex md:flex-row flex-col-reverse justify-between items-center gap-8 mb-20">
          ...
          <div className="space-y-5 md:w-1/2 max-w-xl md:text-left text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg sm:text-xl">
              I’m a relentless innovator, builder of ideas, and visionary
              thinker with a deep foundation in both logic and imagination
            </p>
          </div>
        ...
        <section className="bg-gray-50 dark:bg-gray-800 shadow-md mx-auto mb-16 p-8 rounded-lg max-w-4xl">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
            I’m a relentless innovator, builder of ideas, and visionary thinker
            with a deep foundation in both logic and imagination. Since 2018,
            I’ve actively cultivated a diverse range of CTO-level skills—from
            product strategy and systems design to creative innovation and
            future-focused problem-solving. Alongside my ongoing journey in
            Medicine, I remain deeply immersed in the world of fiction. From
            ancient mythologies and novels to comics, anime, manhwa, and light
            novels—fiction fuels my mind and sharpens my creativity. Though I
            don’t exist on social media, I live fully in creation, craft, and
            meaning.
          </p>
        </section>
