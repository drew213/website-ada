  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900 py-24">
      <div className="mx-auto px-4 container">
        <h2 className="mb-8 text-gray-900 dark:text-white text-3xl sm:text-3xl md:text-4xl lg:text-5xl text-center">
          Word of Mouth that keeps us going
        </h2>
        <div className="gap-6 grid grid-cols-1 md:grid-cols-4 pt-8">
